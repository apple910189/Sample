        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    //check if the role is exist, if not then create it
                    ...
                    //assign the first user as Admin only for first time
                    //await _userManager.AddToRoleAsync(user, SD.Role_Admin);

                    //now this is not the first time, if the role is null, that means this is individual user
                    if (user.Role == null)
                    {
                    ...
                    //After create the user, sign in the user.
                    //First, check if all the roles in database, if not, create all the roles
                    //Second, assign the first registered user as Admin
                    ...
                    {
                        if (user.Role == null)//this means a user is signing from website
                        {
                            //sign in the user
